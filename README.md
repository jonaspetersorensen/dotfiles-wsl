...
- [Microsoft/WSL git repo](https://github.com/Microsoft/WSL/) - MS is fairly active in answering issues and providing workarounds when possible until fix is available
